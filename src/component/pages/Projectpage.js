...
const sortOptions = [
  { name: 'Data Structure', href: '#', current: true },
  { name: 'Web Developnment', href: '#', current: false },
...
const filters = [
  ...
  },
  {
    ...
    name: 'DSA',
    options: [
      { value: 'LEETCODE', label: 'LEETCODE', checked: false },
      { value: 'CODECHEF', label: 'CODECHEF', checked: false },
    ],
  },
  {
    id: 'MACHINE LEARNING',
  ...
  const [mobileFiltersOpen, setMobileFiltersOpen] = useState(false)
    ...
    return (
      ...
      <div bg-gray-900>
        ...
        <Transition.Root show={mobileFiltersOpen} as={Fragment} bg-gray-900>
              ...
              >
                <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-gray-900 py-4 pb-12 shadow-xl">
                  <div className="flex items-center justify-between px-4">
                    <h2 className="text-lg font-medium text-gray-300 bg-gray-900">Filters</h2>
                    <button
                      type="button"
                  ...
                  {/* Filters */}
                  <form className="mt-4 border-t border-gray-200 bg-gray-900">
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-2xl font-bold tracking-tight text-gray-300">Hi ! my self Amit kumar i am B-tech Student at Nit Arunachal Pradesh i Am adding some of my beautiful projects here</h1>
            ...
            <div className="flex items-center">
              ...
              >
                <span className="sr-only" bg-gray-900>Filters</span>
                    ...
                    {({ open }) => (
                      <>
                        <h3 className="-my-3 flow-root">
                          <Disclosure.Button className="flex w-full items-center justify-between bg-gray-900 py-3 text-sm text-gray-200 hover:text-gray-500">
